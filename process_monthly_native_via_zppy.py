"""process_monthly_swcf_via_zppy.py
...
v3.LR.highECS.historical ensembles.  For each member that does not yet have:
    ...
    /global/cfs/cdirs/e3smdata/simulations/v3.XLE/{casename}/
        post/atm/native/ts/monthly/5yr/TGCLDLWP_*.nc
...
Run:  python process_monthly_swcf_via_zppy.py
"""
...
TEMPLATE_CFG = SCRIPT_DIR / "monthly_timeseries_zppy_template.cfg"
TEMP_SCRIPTS = SCRIPT_DIR / "temp_scripts"
BASE_SIM_DIR = Path("/global/cfs/cdirs/e3smdata/simulations/v3.XLE")
CHECK_RELPATH = "post/atm/native/ts/monthly/5yr/TGCLDLWP_*.nc"
...
def main():
    ...
    for ensemble, members in ENSEMBLE_MEMBERS.items():
        for member_id in members:
            ...
            cfg_file = TEMP_SCRIPTS / f"monthly_timeseries_zppy_{casename}.cfg"
